  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#080B0D] text-[#EEF5ED] selection:bg-[#B7FF5A] selection:text-[#080B0D]">
      ...
      <section id="contact" className="border-t border-[#B7FF5A]/20 bg-[#0D1416]">
        <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-24"><div className="grid gap-10"><div><div className="mb-6 flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.2em] text-[#B7FF5A]"><span className="h-px w-9 bg-[#B7FF5A]" />[ contact us ]</div><h2 className="max-w-[520px] font-display text-5xl font-bold leading-[.9] tracking-[-.07em] text-white md:text-7xl">Pick your<br /><span className="text-[#B7FF5A]">signal.</span></h2><p className="mt-6 max-w-[360px] leading-relaxed text-white/55">Reach the Codeforge team through the channel that fits the conversation. Choose one signal below.</p></div><div><div className="mb-5 font-mono text-[10px] uppercase tracking-[0.18em] text-white/35">[ available channels ]</div><div className="grid gap-4 sm:grid-cols-3"><a href="https://www.instagram.com/not_your_pranam/" target="_blank" rel="noreferrer" className="group flex min-h-[190px] flex-col justify-between border border-[#B7FF5A]/70 bg-[#B7FF5A] p-6 text-[#080B0D] transition hover:-translate-y-1 hover:bg-white md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#080B0D]/55">Pranam / Instagram</div><Instagram size={28} strokeWidth={1.5} className="transition group-hover:rotate-12" /></div><div><div className="font-display text-3xl font-bold leading-tight tracking-[0.01em]">@not_your_pranam</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-[#080B0D]/60">Open the conversation ↗</div></div></a><a href="mailto:pranamb67@gmail.com" className="group flex min-h-[190px] flex-col justify-between border border-white/20 bg-[#11181B] p-6 text-white transition hover:-translate-y-1 hover:border-[#B7FF5A] md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#B7FF5A]">Pranam / Email</div><Mail size={28} strokeWidth={1.5} className="text-[#B7FF5A] transition group-hover:-rotate-12" /></div><div><div className="break-all font-display text-xl font-bold leading-snug tracking-[0.01em] md:text-2xl">pranamb67@gmail.com</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-white/45">Send a message ↗</div></div></a><a href="https://www.instagram.com/maybe.tanishh/" target="_blank" rel="noreferrer" className="group flex min-h-[190px] flex-col justify-between border border-white/15 bg-[#EEF5ED] p-6 text-[#080B0D] transition hover:-translate-y-1 hover:border-[#B7FF5A] md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#6EA83A]">Tanish / Instagram</div><Instagram size={28} strokeWidth={1.5} className="text-[#6EA83A] transition group-hover:rotate-12" /></div><div><div className="font-display text-3xl font-bold leading-tight tracking-[0.01em]">@maybe.tanishh</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-black/45">Message Tanish ↗</div></div></a></div></div></div></div>
      </section>
