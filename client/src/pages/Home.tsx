    ...
    <main className="min-h-screen overflow-hidden bg-[#151514] text-[#F3F0E8] selection:bg-[#E8A23A] selection:text-[#151514]">
      ...
      <section id="about" className="bg-[#151514]">
        <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28">
          ...
          <div className="mt-16 border-t border-white/10 pt-8"><div className="mb-5 font-mono text-[10px] uppercase tracking-[0.18em] text-white/35">Choose a channel</div><div className="grid gap-4 md:grid-cols-3"><a href="https://www.instagram.com/not_your_pranam/" target="_blank" rel="noreferrer" className="group flex min-h-[170px] flex-col justify-between border border-[#E8A23A]/70 bg-[#E8A23A] p-6 text-[#151514] transition hover:-translate-y-1 hover:bg-white md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#151514]/55">Social / Instagram</div><Instagram size={28} strokeWidth={1.5} className="transition group-hover:rotate-12" /></div><div><div className="font-display text-3xl font-bold tracking-[-0.05em]">@not_your_pranam</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-[#151514]/60">Open the conversation ↗</div></div></a><a href="mailto:pranamb67@gmail.com" className="group flex min-h-[170px] flex-col justify-between border border-white/20 bg-[#20201D] p-6 text-white transition hover:-translate-y-1 hover:border-[#E8A23A] md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#E8A23A]">Direct / Email</div><Mail size={28} strokeWidth={1.5} className="text-[#E8A23A] transition group-hover:-rotate-12" /></div><div><div className="break-all font-display text-2xl font-bold tracking-[-0.05em] md:text-3xl">pranamb67@gmail.com</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-white/45">Send a message ↗</div></div></a><a href="https://www.instagram.com/maybe.tanishh/" target="_blank" rel="noreferrer" className="group flex min-h-[170px] flex-col justify-between border border-white/15 bg-[#F3F0E8] p-6 text-[#151514] transition hover:-translate-y-1 hover:border-[#E8A23A] md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#A66A15]">Support / Instagram</div><Instagram size={28} strokeWidth={1.5} className="text-[#A66A15] transition group-hover:rotate-12" /></div><div><div className="font-display text-3xl font-bold tracking-[-0.05em]">@maybe.tanishh</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-black/45">Message Tanish ↗</div></div></a></div></div>
        </div>
      </section>
