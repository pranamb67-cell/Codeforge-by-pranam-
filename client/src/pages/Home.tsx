    ...
    <main className="min-h-screen overflow-hidden bg-[#080B0D] text-[#EEF5ED] selection:bg-[#B7FF5A] selection:text-[#080B0D]">
      ...
      <section id="about" className="bg-[#080B0D]">
        <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28">
          ...
          <div className="mt-16 border-t border-white/10 pt-8"><div className="mb-5 font-mono text-[10px] uppercase tracking-[0.18em] text-white/35">[ choose a channel ]</div><div className="grid gap-4 md:grid-cols-3"><a href="https://www.instagram.com/not_your_pranam/" target="_blank" rel="noreferrer" className="group flex min-h-[170px] flex-col justify-between border border-[#B7FF5A]/70 bg-[#B7FF5A] p-6 text-[#080B0D] transition hover:-translate-y-1 hover:bg-white md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#080B0D]/55">Social / Instagram</div><Instagram size={28} strokeWidth={1.5} className="transition group-hover:rotate-12" /></div><div><div className="font-display text-3xl font-bold tracking-[-0.05em]">@not_your_pranam</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-[#080B0D]/60">Open the conversation ↗</div></div></a><a href="mailto:pranamb67@gmail.com" className="group flex min-h-[170px] flex-col justify-between border border-white/20 bg-[#11181B] p-6 text-white transition hover:-translate-y-1 hover:border-[#B7FF5A] md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#B7FF5A]">Direct / Email</div><Mail size={28} strokeWidth={1.5} className="text-[#B7FF5A] transition group-hover:-rotate-12" /></div><div><div className="break-all font-display text-2xl font-bold tracking-[-0.05em] md:text-3xl">pranamb67@gmail.com</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-white/45">Send a message ↗</div></div></a><a href="https://www.instagram.com/maybe.tanishh/" target="_blank" rel="noreferrer" className="group flex min-h-[170px] flex-col justify-between border border-white/15 bg-[#EEF5ED] p-6 text-[#080B0D] transition hover:-translate-y-1 hover:border-[#B7FF5A] md:p-8"><div className="flex items-start justify-between"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#6EA83A]">Support / Instagram</div><Instagram size={28} strokeWidth={1.5} className="text-[#6EA83A] transition group-hover:rotate-12" /></div><div><div className="font-display text-3xl font-bold tracking-[-0.05em]">@maybe.tanishh</div><div className="mt-2 font-mono text-[10px] uppercase tracking-[0.14em] text-black/45">Message Tanish ↗</div></div></a></div></div>
        </div>
      </section>
