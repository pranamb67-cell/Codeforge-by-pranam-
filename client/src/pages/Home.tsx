  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#151514] text-[#F3F0E8] selection:bg-[#E8A23A] selection:text-[#151514]">
      ...
      <section id="about" className="bg-[#151514]">
        <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28"><div className="mb-12 flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.2em] text-[#E8A23A]"><span className="h-px w-9 bg-[#E8A23A]" />The people behind the build</div><div className="grid gap-10 md:grid-cols-[1.2fr_.8fr] md:items-end"><div><h2 className="max-w-[720px] font-display text-5xl font-bold leading-[.9] tracking-[-.07em] md:text-8xl">Good software<br /><span className="text-white/35">has a point of view.</span></h2><p className="mt-8 max-w-[540px] text-lg leading-relaxed text-white/60">Codeforge is owned by <strong className="text-white">Pranam</strong>, built as a place for ambitious programmers to sharpen their thinking. Supported by <strong className="text-[#E8A23A]">Tanish</strong>, who keeps the signal clear and the work moving.</p></div><div className="border-l border-[#E8A23A] pl-6"><div className="font-mono text-[10px] uppercase tracking-[0.18em] text-white/35">A note from the makers</div><p className="mt-4 font-display text-2xl leading-tight text-white/85">“Build the part you’ll still understand six months from now.”</p></div></div><div className="mt-20 flex flex-wrap items-center justify-between gap-8 border-t border-white/10 pt-6"><div className="flex items-center gap-3 font-mono text-xs text-white/45"><Code2 size={15} className="text-[#E8A23A]" /> codeforge / pranam</div><div className="flex items-center gap-6 font-mono text-[10px] uppercase tracking-[0.16em] text-white/35"><span>Owner — Pranam</span><span>Support — Tanish</span><button onClick={() => toast.success("Thanks for stopping by the workbench.")} className="text-[#E8A23A] transition hover:text-white">Say hello <ArrowUpRight className="ml-1 inline" size={13} /></button></div></div></div>
      </section>
